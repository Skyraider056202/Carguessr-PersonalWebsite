...
class registration_form(FlaskForm):
    ...
    password = PasswordField('Enter a Password', validators= [data_required(), length(min=8, max=20)])
    confirm_password = PasswordField('Confirm your Password', validators= [data_required(), length(min=8, max=20), equal_to('password')])
...
class login_form(FlaskForm):
    ...
    password = PasswordField('Enter Password', validators= [data_required(), length(min=8, max=20)])
